...
export const SECOES = [
  ...
  /*
    ...
    ⚠ **Três delas não têm protocolo NENHUM** — `tag`, `figurinhas` e `sons`
    não têm campo, rota nem evento no Stoat. Elas entram mesmo assim, pela
    regra de quem toca o produto: a interface é construída 1:1 com a
    ...
    e `modelo` passou a ter no fork do `api` (`/servers/{id}/template`).
  */
  "tag",
  "modelo",
  "figurinhas",
