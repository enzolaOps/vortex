...
| Gate depois do passe de design | **Pendente, e o número que existe não vale.** Mediana de 3 janelas ANTES do divisor de dia e da inversão de hierarquia: PASS com 1,4% · 1,5% · 1,7% de frames perdidos contra teto de 5%. Depois delas houve **uma** corrida, que deu PASS a 2,3% — mas com **vazão de 330 de 500 ev/s** e janela de 1642 frames em vez de ~4000, com a máquina disputada. É exatamente a armadilha já registrada: gate que entrega metade da carga aprova metade do que afirma. Refazer com mediana de 3 e vazão cheia antes de tratar como medido. O divisor de dia MUDA a altura da linha de divisor, então a corrida importa. |
