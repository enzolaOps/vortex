...
| Remedição de linha prependada | O prepend foi implementado e a âncora **verificada**: 50 antigas, total +2200px, scroll +2200px, deslocamento visual 0px. Mas 2200 é 50×44 — o valor *estimado*: as linhas entraram acima do viewport e nunca foram medidas. Falta o caso de segunda ordem: rolar PARA DENTRO do bloco antigo, onde a estimativa vira altura real e o total cresce de novo. É onde lista de chat costuma quebrar. |
