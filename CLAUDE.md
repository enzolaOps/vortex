...
| Recuo lateral: 16 aqui, 20 no design | **Pendência, e a razão de não ter mudado junto é a invariante.** O design usa `20px` de recuo lateral tanto na lista quanto no composer; nós usamos 16 nos dois. Mudar só um quebra a lei "composer alinhado à coluna de mensagem"; mudar os dois toca a lista de mensagens, e o gate precisa acompanhar. |
