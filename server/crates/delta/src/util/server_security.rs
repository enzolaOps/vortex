...
use regex::Regex;
use revolt_database::{
    user_email_verified, Channel, Database, Invite, Member, RelationshipStatus, Server, User,
};
...
async fn enforce_server_channel(
    ...
    if security
        ...
        && data
            .content
            .as_ref()
            .is_some_and(|content| content.contains("@everyone") || content.contains("@online"))
    {
